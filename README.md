...
| Validita                          | Fungující v moderních prohlíčečích v posledních vývojových verzích (Chrome, Firefox, Edge, Opera) |         |      2 | Platí pro vše, ne jenom HTML | FileSystemHandle is supported on Chrome, Opera and Edge but not on Safari and Firefox.                                                      | 
